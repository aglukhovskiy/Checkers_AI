...
exp = load_experience(h5py.File('models_n_exp/experience_checkers_reinforce_all_iters_custom_fiveteenplane_2.hdf5'))
exp2 = load_experience(h5py.File('models_n_exp/experience_checkers_reinforce_all_iters_custom_fiveteenplane_2_2.hdf5'))
...
print(exp2.states.shape)

print(exp.states[10000]==exp2.states[10000])

print('--------------------')
print(exp.states[100000])
print('--------------------')
print(exp2.states[100000])
print('--------------------')
